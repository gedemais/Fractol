...
float		ft_fractals_tree(t_fract *s, int mask, char w, float juliax, float juliay);


float	ft_fractals_tree(t_fract *s, const int mask, const char w, const float juliax, const float juliay)
{
	float	tx;
	float	ty;
